<script>
  ...
  import santoaloysius from "./logo-santoaloysius.jpeg";
	...
	const winners = [
    participants[0], participants[3], participants[6], participants[7], participants[8],
    participants[9], participants[11], participants[15], participants[16],
    participants[17], participants[18], participants[20], participants[21],
    participants[22], participants[23], participants[27], participants[28]
  ];
	let shownWinners = [];
